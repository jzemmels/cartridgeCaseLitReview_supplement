...
- **Step 3**: Combine numerical features into a single similarity *score*
...
- For a matching cartridge case pair...
  ...
  2. The different regions should be relatively small (in area)
...
- Compare random logistic regression and random forest trained on 21,945 pairwise comparisons (from 210 scans)
...
![](images/classifResultsPlt-trainTest.png){fig-align="center"  height=400}

**Takeaways:**

- Test accuracy metrics improve with progressively larger feature sets

- Comparable performance between random forest (RF) and logistic regression (LR) classifiers
