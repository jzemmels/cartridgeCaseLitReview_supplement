...
For our purposes, it's useful to think of the examination as three distinct steps: pre-processing, comparison, and scoring.
pre-processing might involve adjusting the lighting conditions of the comparison stage.
...
One problem here is that the pre-process, comparison, and scoring stages are done implicitly by the examiner and is difficult to reproduce exactly.
...
### Registration Details {.smaller .scrollable}

![](images/compStep3Example.png){fig-align="center" width=700}
...
### Cell-based Comparison Procedure {.smaller .scrollable}
...
## Implementation: `cmcR` {.smaller .scrollable}
...
![](images/preProcessPipelineSwap.png){fig-align="center" width=700}
...
![](images/cartridgeCasePipelineDiagram_diagnostics.png){fig-align="center" width=700}
...
![](images/cartridgeCasePipelineDiagram_newModules.png){fig-align="center" width=700}
...
### Visual Diagnostic Feature Definitions {.smaller .scrollable}
...
## Classification Results {.smaller .scrollable}

![](images/classifResultsPlt_trainTest.png){fig-align="center"  width="90%"}
...
## Conclusions & Future Work {.smaller .scrollable}
